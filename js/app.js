...
const genres = [
  ...
  { n:'Nouveautés', c1:'#E8C77E', c2:'#8A6A2E', anim:'anim-twinkle',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v4M12 17v4M3 12h4M17 12h4M6 6l2.5 2.5M15.5 15.5 18 18M18 6l-2.5 2.5M8.5 15.5 6 18"/></svg>' },
  { n:'Top Congo', c1:'#D4AF6A', c2:'#5C3A18', anim:'anim-sheen',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 17h16l-1.4-6.4-3.8 3-2.8-5-2.8 5-3.8-3z"/><path d="M8 20h8"/></svg>' },
  { n:'Rap', c1:'#8B96B0', c2:'#141A38', anim:'anim-pulse-ring',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M5 15V9M9.5 18V6M14 15V9M18.5 12.5V11.5"/></svg>' },
  { n:'Rumba', c1:'#D98A3D', c2:'#7A4A24', anim:'anim-strum',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M5 19 18 6" opacity=".5"/><path d="M8 19 18 9" opacity=".75"/><path d="M11 19 18 12"/></svg>' },
  { n:'Gospel', c1:'#F1ECE3', c2:'#B89355', anim:'anim-rise',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="9" r="4.4"/><path d="M12 15v6M8 4.5l.6 1.4M16 4.5l-.6 1.4M5.5 8l1.4.6M18.5 8l-1.4.6"/></svg>' },
  { n:'Afro', c1:'#1E8449', c2:'#B8860B', anim:'anim-wave',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"><path d="M12 2 20.5 12 12 22 3.5 12z"/><path d="M12 8 16 12 12 16 8 12z"/></svg>' },
  { n:'Hip-Hop', c1:'#4A2E70', c2:'#8B96B0', anim:'anim-bounce',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><circle cx="10.5" cy="13" r="7"/><circle cx="10.5" cy="13" r="1.3" fill="currentColor" stroke="none"/><path d="M16 6.5 20.5 4.5M20.5 4.5v4"/></svg>' },
  { n:'Traditionnel', c1:'#1F4D2C', c2:'#8C6239', anim:'anim-glow-pulse',
    icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"><path d="M4 9h4v4H4zM8.5 13h4v4h-4zM13 9h4v4h-4zM17.5 13h4v4h-4z"/></svg>' },
];
